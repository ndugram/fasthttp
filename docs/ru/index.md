...
* **На Rust**: критичные по производительности внутренности (обработка URL, парсинг HTML, сериализация JSON) скомпилированы как расширения Rust через PyO3 — поставляются как готовые wheels, Rust не требуется.
...
* **Полный**: GET, POST, PUT, PATCH, DELETE, HEAD, OPTIONS, QUERY и GraphQL из коробки.
...
<p align="center">
  <a href="https://sudoteach.com" target="_blank"><strong>SudoTeach</strong></a> — платформа для обучения программированию. Практические курсы по Python, бэкенду и DevOps от практикующих разработчиков.
</p>
